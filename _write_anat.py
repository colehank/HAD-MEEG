...
from mne_bids import find_matching_paths, BIDSPath, get_entity_vals, write_anat
...
anat_imgs = {
    sub: find_matching_paths(
        ...
        extensions='.nii.gz', datatypes='anat') for sub in fmri_subs
}
...
# %%
sub_evs = {sub: config.derivatives_root / f"detailed_events/sub-{sub}_events.csv" for sub in config.subjects}
